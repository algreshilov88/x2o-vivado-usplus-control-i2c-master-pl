...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_jtag_fifo_proc is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of TCK_0_INST_0 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of TCK_1_INST_0 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of TDI_0_INST_0 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of TDI_1_INST_0 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of TMS_0_INST_0 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of TMS_1_INST_0 : label is "soft_lutpair10";
...
\bit_count[31]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\tms_output[31]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFF4FFFF"
    )
        port map (
...
u_jtag_fifo_proc: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_jtag_fifo_proc
     port map (
      ...
      enable_d => enable_d,
      s_axis_aclk => s_axis_aclk,
      \tdi_output_reg[31]_0\(0) => u_jtag_fifo_n_4,
      \tms_output_reg[30]_0\(30) => u_jtag_fifo_n_37,
      \tms_output_reg[30]_0\(29) => u_jtag_fifo_n_38,
      \tms_output_reg[30]_0\(28) => u_jtag_fifo_n_39,
      \tms_output_reg[30]_0\(27) => u_jtag_fifo_n_40,
