...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  port (
    ...
    slave_error_top_0_1 : in STD_LOGIC_VECTOR ( 1 downto 0 );
    slave_error_bot_2_3 : in STD_LOGIC_VECTOR ( 1 downto 0 );
    reg_ro : out STD_LOGIC_VECTOR ( 31 downto 0 );
    reg_com_ro : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^slave_error_bot_2_3\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^slave_error_top_0_1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
...
begin
  ...
  \^slave_error_bot_2_3\(1 downto 0) <= slave_error_bot_2_3(1 downto 0);
  \^slave_error_top_0_1\(1 downto 0) <= slave_error_top_0_1(1 downto 0);
  ...
  reg_com_ro(3 downto 2) <= \^slave_error_bot_2_3\(1 downto 0);
  reg_com_ro(1 downto 0) <= \^slave_error_top_0_1\(1 downto 0);
  ...
  serial_4 <= \^reg_com_rw\(4);
  tck_clk_ratio_3_0(3 downto 0) <= \^reg_com_rw\(3 downto 0);
