...
wire bus_free = scl_pad_i && sda_pad_i && !i2c_busy;
...
begin
    ...
    else if (state == S_IDLE && i2c_write_req && !bus_free)
    begin
...
wire rec_trigger = !rec_active && (core_i2c_dhang || core_i2c_chang || mhang || (ibusy && !sda_pad_i));
